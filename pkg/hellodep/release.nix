...
let
  ...
  vendor =
    with deps; [ ed25519 secp256k1 murmur3 uv ];
    # [ argon2 sni scrypt softfloat3 h2o ent ];

in

env.make_derivation {
  inherit (deps) ed25519 secp256k1 murmur3 uv;
    # argon2 ed25519 sni scrypt softfloat3 secp256k1 h2o ent;
